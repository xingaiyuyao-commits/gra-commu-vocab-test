...
SERIES[25] = dict(
    ...
    words=[
        ...
        ("stipulate", "/ˈstɪp.jə.leɪt/", "verb", "stipulates, stipulated", "規定する、明記する", "This contract <i>stipulates</i> a thirty-day notice period.", "この契約書は30日前の通知期間を規定している。"),
        ...
        ("delineate", "/dɪˈlɪn.i.eɪt/", "verb", "delineates, delineated", "明確に示す、輪郭を描く", "This map <i>delineates</i> the boundary between the two regions.", "この地図はその二つの地域の境界を明確に示している。"),
